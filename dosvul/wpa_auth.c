...
//Here we set the initial values for our fuzzer skip variables as this is where wpa_auth begins
int fuzzer_skip_4way = 0;
int fuzzer_skip_probe_response = 0;
int fuzzer_skip_auth_commit = 0;
int fuzzer_skip_auth_confirm = 0;
int fuzzer_skip_assoc_resp = 0;
int fuzzer_skip_msg1 = 0;
int fuzzer_skip_msg3 = 0;
...
#ifdef CONFIG_FRAMEWORK_EXTENSIONS
//This should skip the 4way handshake as provided by the framework developers but it only blocks it once
	if (fuzzer_skip_4way) {
