...
//We must define the fuzzer variables again here as they will be used as checks for hostap
// to determine if it will send an auth commit, auth confirm, and/or association response
